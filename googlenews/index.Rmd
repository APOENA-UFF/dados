...
O impacto das linguagens estruturadas em matérias 
1. Os discursos nas mídias são práticas sociais.
2. Dar uma atenção maior ao papel desempenhado pelas linguagem nas mídias.
3. Desenvolver um método para avaliar a linguagem das mídias - uma maneira de relatar uma percepção da LAB
...
Todos discursos nas mídias têm um contexto de produção.   
...
Frequência de palavras que estão mais em um grupo do que em outro
...
### Apesar de ser uma lei do setor cultural, teve impacto em toda sociedade (Legislativo, Municípios, Estados, Blogs, mídia alternativa, mídia tradicional)
<br>
<br>
### Encontramos evidências de discursos da esquerda e da direita sobre o impacto da LAB na sociedade
...
* Análise das postagens compartilhadas em **4.353 matérias**, no período de 25/02/2021 e 15/11/2022 em torno da LAB.

* Identificamos uma distinção entre o **Estado**, **Mídia Corporativa** e **Mídia alternativa** . 

* A **direita** concentra a sua fala sobre ???, enquanto a **esquerda** fala de ????a origem de criação, em seus processos de autoria, relatoria e aprovação da LAB. 

---

## Conclusão REESCREVER
