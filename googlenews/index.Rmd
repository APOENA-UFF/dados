...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
knitr::include_graphics("img/positiva1.png")
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
knitr::include_graphics("img/negativa1.png")
...
### REFAZER 1. Apesar de ser uma lei do setor cultural, a quantidade de favoritos e retweets está relacionada a políticos e não aos artistas (apropriação por parte dos politicos da visibilidade da LAB)
<br>
### REFAZER 2. Encontramos evidências de atores políticos relacionando a LAB a uma Guerra Cultural
