...
valueBox(format(sum(BD_APOENA_RJ$valor_total,na.rm = T),big.mark='.',
 small.mark=',',decimal.mark=','), caption = "Valor total - Rio de Janeiro", color = "#fe9c8f", icon = "fa-music")
...
valueBox(format(sum(BD_APOENA$pagamentos_realizados_pela_uniao,na.rm = T),big.mark='.',
 small.mark=',',decimal.mark=','), caption = "Pagamento realizados pela união - Brasil", color = "#4b86b4", icon = "fa-book-reader")
...
valueBox(format(sum(BD_APOENA_RJ$pagamentos_realizados_pela_uniao,na.rm = T),big.mark='.',
 small.mark=',',decimal.mark=','), caption = "Pagamento realizados pela união - Rio de Janeiro", color = "#feb2a8", icon = "fa-book-reader")
...
valueBox(format(sum(BD_APOENA$saldo_em_conta_plataforma_de_indicadores,na.rm = T),big.mark='.',
 small.mark=',',decimal.mark=','), caption = "Saldo em conta plataforma de indicadores - Brasil", color = "#e7eff6", icon = "fa-palette")
...
valueBox(format(sum(BD_APOENA_RJ$saldo_em_conta_plataforma_de_indicadores,na.rm = T),big.mark='.',
 small.mark=',',decimal.mark=','), caption = "Saldo em conta plataforma de indicadores - Rio de Janeiro", color = "#fad9c1", icon = "fa-palette")
```
...
valueBox(format(4175,big.mark='.',
 small.mark=',',decimal.mark=','), caption = "planos aprovados em 2020 - Brasil", color = "#63ace5", icon = "fa-child")
...
valueBox(format(87,big.mark='.',
 small.mark=',',decimal.mark=','), caption = "planos aprovados em 2020 - Rio de Janeiro", color = "#f9caa7", icon = "fa-child")
```
